...
---
- Comes with a simple setup menu and a one click installer for the main app, (3 options : check requirements / repair/reset app / full install) It will install an environment for the app and the smaller models such as upscalers)
- The bigger models can be selected/installed/downloaded/removed or hidden inside the app.
...
- RTX graphics card with at least 8-12 gigabyte of vram is advised for most models, some models like hunyuan 1.5 and wan 2.2 may need 24 gig of vram without ofloading
...
* Choice between:
  ...
  * **FP8** — experimental, since FP8 because my rtx 3090 cannot test it properly.
* Comes with the updated **distilled 1.1 model**.
* Users can also load their own model safetensors, such as Eros or Sulphur.
* Includes advanced settings such as:

  * Start video and/or end video.
  * Start image, middle image, and end image.
...
* The unconditional GGUF can be Q2 and still look pretty good.
