...
# Note Lines — Bold: fewer but larger notes moving left→right on staff lines.
# Symbols: ♫ ♪ ♩ ♬ ♭ ♮ ♯
import random, math
...
# ===== Beat driver (as per working examples) =====
...
class NoteLinesBold(BaseVisualizer):
    ...
    def paint(self, p:QPainter, r, bands, rms, t):
        ...
        for _ in range(spawn):
            ...
            size = int(min(w,h)*0.065 + 14*random.random())  # bigger notes
            _ACTORS.append({
                "x": -80.0, "y": y,
                "speed": speed,
                "size": size, "life": 1.0,
