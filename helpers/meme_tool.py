...
# Form
    ...
    def _on_rot_changed(self, val):
        try:
            s = getattr(self, "sl_rot", None)
            if s is not None and getattr(s, "isSliderDown", lambda: False)():
