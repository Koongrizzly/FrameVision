    ...
    def __init__(self, parent=None, standalone: bool = False):
        ...
        try:
            ...
            self.vram_lab.setToolTip(
                ...
                "On uses the current safe/default VRAM Lab path while Hunyuan is being stabilized."
            )
        except Exception:
            pass
        ...
        try:
            adv_form.addRow(QLabel("VRAM control:"), self.vram_lab)
        except Exception:
            pass
...
# Restore Queue toggle (Use Queue) — forced OFF when Extend > 0
    ...
    def _wire_autosave(self) -> None:
        ...
        # combos
        for cb_name in ("model", "attn", "resolution", "aspect", "vram_lab"):
            try:
