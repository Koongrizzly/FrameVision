...
def _tool_ready_status(models_dir: str) -> Dict[str, Optional[str]]:
    ...
    # Ace Music — checks if ROOT/presets/extra_env/ace_env exists (folder)
    ace_music = os.path.isdir(os.path.join(ROOT, "presets", "extra_env", ".ace_env"))
    ...
    # HunyuanVideo 1.5 — checks if ROOT/.hunyuan15_env exists
...
def _tools_line(status: Dict[str, Optional[str]]) -> str:
    ...
    group2 = ["Ace Music","Z-image","Wan 2.2","HunyuanVideo 1.5"]
