...
def integrate_into_main_window(main):
    ...
    # Hide tabs that have been moved into Tools (Upscale/Rife)
    try: _hide_tools_tabs(main)
    except Exception: pass
    try:
        QTimer.singleShot(0, lambda: _hide_tools_tabs(main))
        QTimer.singleShot(150, lambda: _hide_tools_tabs(main))
    except Exception:
        pass
    return main
