...
class Wan22Pane(QWidget):
    ...
    def __init__(self, main=None, parent: Optional[QWidget] = None):
        ...
        # End image experimental helper-level workaround removed.
...
# --- Process handling ---------------------------------------------------
    ...
    def _hidden_engine_flags(self) -> tuple[bool, bool, bool, bool, bool]:
        """Return hidden flags for Wan normal/Wan Turbo/Hunyuan/HiAR/LTX from remove_hide state."""
        try:
        ...
        try:
            ...
            if preserve_key is None:
                try:
                    ...
                    preserve_key = None
            hide_wan22, hide_wan22_turbo, hide_hunyuan15, hide_hiar, hide_ltx23 = self._hidden_engine_flags()
            ...
            self._all_engines_hidden = bool(hide_wan22 and hide_wan22_turbo and hide_hunyuan15 and hide_hiar and hide_ltx23)
    ...
    def _sync_engine_view(self, save: bool = False):
        ...
        if key not in ("wan22", "wan22_turbo", "hunyuan15", "hiar", "ltx23"):
            try:
    ...
    def _build_turbo_command(self, py: str, model_root: Path, mode: str, prompt: str, image: str, seed_value: int, out_path: Path):
        ...
        if vram_mode != "off":
            ...
            if not self._wan_flash_attention_enabled():
    ...
    def _end_image_feature_enabled(self) -> bool:
        # Removed experimental end-image workaround. Wan 2.2 has no reliable native end-image path here.
        return False
