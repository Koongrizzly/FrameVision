...
# GIF
        ...
        default_sections = [s for s in [sec_prompt, sec_bg, sec_ace, sec_mula, sec_describe, sec_qwen3tts, sec_meme, sec_music, sec_audio, sec_speed, sec_reverse, sec_upscale, sec_rife,
