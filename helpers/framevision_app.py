...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle(APP_NAME + " V2.4 " + TAGLINE)
...
# <<< FRAMEVISION_EDITOR_INIT_END
        ...
        _main_tabs = [("Edit", self.edit),("Background", self.background),("Media Explorer", self.media_explorer),("Tools", self.tools),("Describe", self.describe),("Planner", self.planner),("Queue", self.queue),("Presets", self.presets_tab),("Settings", self.settings)]
        try:
